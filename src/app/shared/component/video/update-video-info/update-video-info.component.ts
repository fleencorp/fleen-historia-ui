...
export class UpdateVideoInfoComponent {

  @Input('update-video-form') public videoForm!: FormGroup;
  ...
  @Output('update-video') updateVideo$: EventEmitter<any> = new EventEmitter<any>();

  public updateVideo(): void {
    this.updateVideo$.emit();
  }
